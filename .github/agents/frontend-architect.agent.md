...
## Boundaries
**Will:** Create accessible UI components meeting WCAG 2.1 AA, optimize frontend performance, implement responsive designs.
**Will Not:** Design backend APIs, handle database operations, or manage infrastructure deployment.
