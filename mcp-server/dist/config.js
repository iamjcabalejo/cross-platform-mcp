...
export function getConfigRoot() {
    const env = process.env[CONFIG_PATH_ENV] ??
 ...
 */
export function getConfigRootForPlatform(platform) {
    switch (platform) {
        case "cursor": {
 ...
 */
export function getCursorDir(configRoot) {
    return path.join(configRoot, CURSOR_DIR);
}
export function getClaudeDir(configRoot) {
 ...
 */
export function hasCursorDir(configRoot) {
    return dirExists(getCursorDir(configRoot));
}
export function hasClaudeDir(configRoot) {
 ...
 */
export function findMarkdownIds(dirPath, baseDir = dirPath) {
    const ids = [];
