...
async function main() {
    ...
    if (active.length === 0) {
        logError("No config found", "Set CONFIG_PATH (or CURSOR_CONFIG_PATH / CLAUDE_CONFIG_PATH / CODEX_CONFIG_PATH) to a directory containing .cursor, .claude, or Codex .agents/skills or .codex/rules.");
    }
